    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{VM Service Catalog}
          {Service Catalog for VM-based stateful systems. Using Saltstack in the background to gather all the grains, this system is scalable enough to manage tens of thousands of servers, and fast enough to communicate with each system in seconds. Currently handles 18k servers}
        \resumeItem{OS and Runtime Upgrade [Ongoing]}
          {OS and Runtime Upgrades are a large scale code refactoring exercise fixing first level dependencies, transitive dependencies, deprecation, backward compatibility \& API changes. It's in experimental phase with current success rate at 50\%.}
        \resumeItem{Production Readiness Review \& Service Maturity Assessment [Ongoing]}
          {These two projects deal with pre \& post deployment of services into production. The services are evaluated on the basis of categories like reliability, security, code quality, service design \& compliance.}
      \resumeItemListEnd
