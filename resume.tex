    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{VM Service Catalog}
          {Architected and delivered a high-scale VM Service Catalog leveraging SaltStack, enabling sub-second orchestration across tens of thousands of servers and standardizing VM provisioning for platform-wide use.}
        \resumeItem{Codelift}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Secret Management}
          {Led org-wide migration of sensitive secrets to a centralized, secure vault-backed solution, enhancing compliance and reducing security vulnerabilities by standardizing secret access and lifecycle management.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Sponsored Listing}
          {Led design and launch of a high-impact Sponsored Listings ad product, driving multi-million dollar revenue with industry-leading conversion rates and highest ad impressions across Expedia verticals.}
